...
### Exams
You will have three exams and a mandatory cumulative final exam. You may not use books, notes, unauthorized calculators, phones, tablets, or software applications during the exams. Each exam is taken in person at the Testing Center in Grayslake. You will have a three day window to take the exam. Exams include vocabulary, short essay, and problems based on homework and notes. Exams are paper and pencil. Testing center hours can be found [here](https://www.clcillinois.edu/community/testing-center).
...
### Weekly Connections
Throughout the semester, you will engage with your classmates through our virtual Padlet board. This interactive space allows us to build a supportive online learning community where you can share ideas, ask questions, and connect with peers despite the distance. Each week, you are expected to either:

- Post one meaningful question or insight about the current material on our class Padlet board
- Respond thoughtfully to a classmate's post, offering help, sharing your approach to a problem, or making connections to other mathematical concepts

Building relationships with your fellow students is a crucial part of your learning journey in this course. These weekly connections help create a collaborative environment where everyone feels comfortable asking questions and sharing their mathematical thinking. Getting to know your classmates and learning from their perspectives will enrich your understanding of precalculus concepts and make the online learning experience more engaging.

Your participation will be evaluated based on the quality and thoughtfulness of your contributions rather than length. Make an effort to engage authentically with your peers' posts and share your own mathematical journey.
...
**Final Exam is Tuesday-Thursday, May 13-15th.**
...
## Late Work Policies
Extensions will be granted on a case-by-case basis and is situation dependent. I understand that things come up, and communication is essential. Emailing me to communicate your situation (if possible before the missed class/assignment) is your responsibility, but not a guarantee of an extension. (csizemore@clcillinois.edu). There is no make-up for exams. The final exam will replace a lowest exam grade (if higher). While this policy provides a safety net for an off day or unexpected circumstances, you should plan to take all three exams. Missing an exam intentionally removes your buffer against illness, emergencies, or underperformance on a later test. Be strategic - take every exam and give yourself the best chance at success in the course.
